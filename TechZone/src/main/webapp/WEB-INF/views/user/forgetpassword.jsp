<%-- 
    ...
    Created on : Nov 9, 2025, 10:21:38 PM
    Author     : acer
--%>
    ...
    <body>
        ...
        -->        <div class="form">
            <div class="login">
                ...
                <form style="margin-left: 30px; width: 452px; display: flex; justify-content: space-between"  action="${pageContext.request.contextPath}/sendcodepassword" method="post">
                ...
                <c:if test='${status == "success"}'>
                    ...
                    <form style="margin-left: 30px; height: 45px; width: 452px; display: flex;" action="sendcodepassword" method="post">
                ...
                <br>
                <input type="button" value="register" class="button" onclick="createNewPassword()">
                <p id="error"></p>
                            ...
                            if (email !== "" && password !== "") {
                                ...
                                if (password.length >= 8) {
                                    if (checkConfirmPassword()) {
                                        if (validateEmail()) {
                                            try {
                                                const res = await fetch("http://localhost:8080/TechZone/forgetpassword", {
                                                    method: "POST",
                                                ...
                                                if (data.success) {
                                                    ...
                                                    alert("forget password failure!: " + data.message);
                                                }
                                            } catch (err) {
                                ...
                                document.getElementById("error").innerHTML = "error, please, you must enter your information such as email, password";
                            }
